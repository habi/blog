...
Wie [vorhin]({{< ref "2022-10-01-recommended-readings.md" >}}) erwähnt, ist [`dask`](2022-10-01-recommended-readings.md) *sehr* gäbig um auf ganz viele Bilder zuzugreifen.
Hier - bei 44 Bildern - ein totaler Overkill, aber bei fast einer Million Bilder wie erwähnt, nötig :)
